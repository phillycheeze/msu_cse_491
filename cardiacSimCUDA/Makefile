...
CUDA_PATH ?= /opt/software/cudatoolkit/6.0/
...
# Gencode arguments
ifeq ($(OS_ARCH),armv7l)
SMS ?= 20 30 32 35 50 #37 50
else
SMS ?= 11 20 30 35 50 #37 50
endif
...
cardiacsim: cardiacsim.o splot.o cmdLine.o
...
clean:
	rm -f cardiacsim *.o
	rm -rf ./bin/$(OS_ARCH)/$(OSLOWER)/$(TARGET)$(if $(abi),/$(abi))/cardiacsim
